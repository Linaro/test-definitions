...
TIME_FS_MOUNT=`echo "${POINT_FS_MOUNT_END} ${POINT_FS_MOUNT_START} - p" | dc`
output_test_result "TIME_FS_MOUNT" "pass" "${TIME_FS_MOUNT}" "s"
...
TIME_BOOTANIM=`echo "${POINT_SERVICE_BOOTANIM_END} ${POINT_SERVICE_BOOTANIM_START} - p" | dc`
output_test_result "TIME_BOOTANIM" "pass" "${TIME_BOOTANIM}" "s"
