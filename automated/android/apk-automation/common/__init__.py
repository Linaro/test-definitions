...
class ApkTestRunner(object):
    ...
    def collect_log(self):
        ...
        self.logger.info('Pulling /data/local/tmp/logcat.log to output directory...')
        ...
        self.logger.info('Pulling /data/local/tmp/logcat-events.log to output directory...')
        self.call_adb('pull /data/local/tmp/logcat-events.log %s' % self.config['output'])

        self.call_adb('shell dmesg > /data/local/tmp/dmesg.log')
        self.logger.info('Pulling /data/local/tmp/dmesg.log to output directory...')
