...
class ApkRunnerImpl(ApkTestRunner):
    ...
    def execute(self):
        ...
        self.report_result('Linpack_MFLOPSSingleScore', 'pass', mflops_single_score.getText(), 'MFLOPS')
        self.report_result('Linpack_TimeSingleScore', 'pass', time_single_score.getText(), 'seconds')
        ...
        self.report_result('Linpack_MFLOPSMultiScore', 'pass', mflops_multi_score.getText(), 'MFLOPS')
        self.report_result('Linpack_TimeMultiScore', 'pass', time_multi_score.getText(), 'seconds')
