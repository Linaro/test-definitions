...
def parse_args():
    ...
    parser.add_argument('-a', '--attachment', dest='attachment', action='append', help='Specify attachment file.')
    ...
    parser.add_argument('-e', '--test-env', dest='test_env', help='Environment identifier. Defaults to board name.')
    parser.add_argument('-u', '--url', dest='url', default='https://qa-reports.linaro.org', help='Dashboard URL. Defaults to https://qa-reports.linaro.org.')
