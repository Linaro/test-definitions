                ...
                for specific_test in specific_tests:
                    if test['path'] == specific_test['path']:
                        if specific_test.get('skip'):
                            self.logger.info('Skipped: {}'.format(test))
                            break
                        if specific_test.get('parameters'):
                            ...
                            if test.get('parameters'):
                                ...
                                fixed_test['paramters'] = specific_test.get('parameters')
...
def get_args():
    ...
    parser.add_argument('-m', '--modify_test_plan', default=None,
                        dest='board_specific', help=textwrap.dedent('''\
                        Specify board specific test definition file.
                        '''))
