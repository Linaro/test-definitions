...
[ "${CONFIG_MMC}" = "CONFIG_MMC=y" ] && [ "${CONFIG_MMC_SDHCI}" = "CONFIG_MMC_SDHCI=y" ]
exit_on_skip "mmc-pre-requirements" "Kernel config CONFIG_MMC=y and CONFIG_MMC_SDHCI=y not enabled"
