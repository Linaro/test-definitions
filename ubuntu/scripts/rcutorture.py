#!/usr/bin/env python
#
# RCU Torture test for Linux-Linaro Kernel based images.
#
...
if 'torture' in lsmod_list:
    collect_result('rcutorture-module-check', 'pass')
    rcutorture_end = 'rmmod torture'
else:
    if 'rcutorture' in lsmod_list:
        collect_result('rcutorture-module-check', 'pass')
        rcutorture_end = 'rmmod rcutorture'
    else:
