...
lava-test-case perfmmap-Avg --result ${avg_result} --units cpucycles --measurement ${tmp_avg}
...
if [ ${tmp_max} -gt 0 ]; then
	...
	lava-test-case perfmmap-Max --result ${avg_result} --units cpucycles --measurement ${tmp_max}
fi
